...
def parse_args():
    ...
    parser.add_argument("-i", "--input", type=str, required=True, help="The input text file")
    ...
    with open(file, "r") as file:
        ...
        for line in file:
            ...
            if line.lower().startswith("location"):
                data['Location'][call_count-1] = line.strip().replace("Location/Address:", "").replace("Location:", "")
                continue
